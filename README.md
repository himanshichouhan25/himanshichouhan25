...
<p align="left"><img src="https://skillicons.dev/icons?i=python,cpp,c,java,javascript" /></p>
...
<img src="https://img.shields.io/badge/Prompt_Engineering-E74C3C?style=for-the-badge"/>
</p>
...
### 🚀 Features
- 🧭 Planner Agent — builds the day-by-day itinerary
- 💰 Budget Agent — checks and optimizes spending
- 🔍 Reflection Agent — reviews and improves the final plan
- 🔐 JWT Authentication (register/login/me)
- 🗂️ Trip history + preferences management
- ⚡ Groq (Llama-3.3-70B) powered reasoning

### 🛠 Tech Stack
`React` `Vite` `Tailwind CSS` `Shadcn UI` `FastAPI` `SQLAlchemy` `SQLite` `JWT` `CrewAI` `Groq`
...
- 🗂️ Review history persisted in SQLite

### 🛠 Tech Stack
`Python` `FastAPI` `Streamlit` `CrewAI` `Groq` `SQLite`

## 📚 Study Buddy Agent
> **An AI-powered CS study companion that explains concepts clearly, gives real examples, and ends every answer with a follow-up question to keep you thinking.**

### 🚀 Features
- 🤖 Explains algorithms, data structures, networking, system design
- 💡 Example-driven, code-snippet answers
- 🗂️ Multi-session chat history in sidebar
...
# 🔥 GitHub Streak
<p align="center">
<img src="https://streak-stats.demolab.com?user=himanshichouhan25&theme=radical&hide_border=true"/>
</p>

# 📈 Contribution Activity
<p align="center">
<img src="https://github-readme-activity-graph.vercel.app/graph?username=himanshichouhan25&theme=react-dark&hide_border=true"/>
</p>
...
# ⏱️ Productivity
<p align="center">
<img src="https://github-profile-summary-cards.vercel.app/api/cards/stats?username=himanshichouhan25&theme=radical"/>
<img src="https://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=himanshichouhan25&theme=radical&utcOffset=5.5"/>
</p>

# 👀 Profile Visitors
<p align="center">
<img src="https://komarev.com/ghpvc/?username=himanshichouhan25&label=Profile+Views&color=A78BFA&style=for-the-badge"/>
</p>
